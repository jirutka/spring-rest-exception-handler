...
import cz.jirutka.spring.exhandler.fixtures.SampleController
import cz.jirutka.spring.exhandler.fixtures.ZuulException
import cz.jirutka.spring.exhandler.fixtures.ZuulExceptionHandler
...
class JavaConfigurationIT extends AbstractConfigurationIT {
    ...
    static class ContextConfig extends WebMvcConfigurerAdapter {
        ...
        @Bean SampleController sampleController() {
